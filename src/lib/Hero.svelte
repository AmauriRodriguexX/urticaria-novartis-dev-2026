...
{#key ctx}<section class="hero context-transition">
  ...
  <div class="hero-art animate-rise delay">
    ...
    <div class="counter"><strong>{target.toLocaleString('es-MX')}</strong><p>personas usaron esta guía esta semana para entender qué les pasa.</p></div>
  </div>
</section>{/key}
