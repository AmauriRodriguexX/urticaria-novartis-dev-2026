<script>
  // Logo de Novartis. La llama conserva siempre su degradado de marca; el
  // logotipo toma `currentColor`, así usa el azul oficial sobre fondos claros
  // y blanco sobre los oscuros sin necesidad de dos archivos.
  //
  // OJO: este archivo se obtuvo de internet, no es el asset oficial. Antes de
  // producción hay que sustituirlo por el que entregue el equipo de marca.
  export let alto = 18
  export let etiqueta = 'Novartis'
  const id = 'novartis-llama-' + Math.random().toString(36).slice(2, 8)
</script>
